          ...
          <div className="col-lg-4 valign">
            <div className="sec-head info-box full-width md-mb80">
              <div className="phone fz-30 fw-600 underline main-color">
                <a href="#0">+92 320 (255) 86 87</a>
              </div>
              <div className="morinfo mt-50 pb-30 bord-thin-bottom">
                <h6 className="mb-15">Address</h6>
                <p>Shaheen Abad, Gujranwala, Pakistan</p>
              </div>
              <div className="morinfo mt-30 pb-30 bord-thin-bottom">
                <h6 className="mb-15">Email</h6>
                <p>awaismughal14301@gmail.com</p>
              </div>
          ...
          <div className="col-lg-7 offset-lg-1 valign">
            <div className="full-width">
              ...
              <form
                id="contact-form"
                className="form2"
                action="https://formsubmit.co/awaismughal14301@gmail.com"
                method="POST"
              >
                <input type="hidden" name="_next" value="http://localhost:3000/page-contact/" />
